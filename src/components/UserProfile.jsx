          ...
          <div className="dropdown-content">
            <div className="user-details">
              <div className="detail-item">
                ...
                <span className="detail-value">{getRoleLabel(currentUser.role)}</span>
              </div>
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">{getOrganizationTypeLabel(currentUser.organizationType)}</span>
              </div>
              ...
              {currentUser.phone && (
                <div className="detail-item">
                  <span className="detail-label">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                      <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122L9.98 10.97a.678.678 0 0 1-.358-.063 5.678 5.678 0 0 1-1.905-1.905.678.678 0 0 1-.063-.358l.538-1.806a.678.678 0 0 0-.122-.58L5.276 3.951a.678.678 0 0 0-.622-.623Z"/>
                    </svg>
                    Phone
                  </span>
              ...
              <div className="detail-item">
                ...
                <span className="detail-value">
                  {formatMemberSince(currentUser.loginTime)}
                </span>
              </div>
            </div>
          ...
          <div className="modal-content profile-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="profile-note">
                <p><strong>Note:</strong> Profile editing is currently read-only. Contact your administrator to update your information.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="modal-body">
              <div className="help-sections">
                <div className="help-section">
                  ...
                  <ul>
                    <li>Use the <strong>Content Builder</strong> to create interactive Learning Modules</li>
                    <li>Upload existing E-Learning content using the <strong>Upload</strong> feature</li>
                ...
                <div className="help-section">
                  ...
                  <div className="contact-info">
                    <p><strong>Email:</strong> support@tgs-elearning.com</p>
